...
<body>
  ...
  <div class="container-fluid" style="height: 535px;">
    <div class="row " style="">
      ...
      <div class="col-md-3">
        <center>
          <h2 style="padding: 5px;color :red">Create Channel</h2>
        </center>

        <div class="cusDiv">
          <p><b>Channel Details :</b></p>
          ...
          <div id="clickMsg">
            <i class="fas fa-mouse-pointer"></i> Click on the Map to add markers to channel.<br>
          </div>
        </div>
        ...
        <footer id="manageBtn" style="display: none;padding-top: 7px;">
          <center>
          <a href="MyChannel.php">
            <button class="btn btn-sm RedButton bClass" type="button" id="rqBtn">
                    <font size="2">Request to Publish <i class="fas fa-plus-circle"></i></font>
            </button>
