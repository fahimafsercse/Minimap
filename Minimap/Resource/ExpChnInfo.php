...
<head>
  ...
  <!-- <script src="js/exploreChannelInfo.js"></script> -->
    ...
    <div class="row " style="">
      ...
      <div class="col-md-3 ">
        ...
        <div class="row">
          <div class="col-md-7">
            <center>
              <h4 style="padding: 15px;color :red">AIUB Mini Map</h4>
            </center>    
          </div>
          ...
          <div class="col-md-5" style="padding-top: 25px">
            <div class="dropdown dropleft">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <button class="dropdown-item" type="button"><i class="fas fa-check"></i> Subscribed</button>
                <button class="dropdown-item" type="button"><i class="fas fa-thumbs-down"></i> Unsubscribe</button>
              </div>
            </div>
          </div>
